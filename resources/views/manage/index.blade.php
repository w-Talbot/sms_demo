@extends('layouts.app', [
    'title' => __('Study Manager'),
    'parentSection' => 'laravel',
    'elementName' => 'study-index'
])
...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('item.index') }}">{{ __('Study') }}</a></li>
                        ...
                        <div class="row align-items-center">
                            ...
                            @if (auth()->user()->can('create', App\Item::class))
                                <div class="col-4 text-right">
                                    <a href="/manage/create" class="btn btn-sm btn-primary">{{ __('Configure New Study') }}</a>
                                </div>
                            @endif
                        </div>
                    </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="/manage/edit">{{ __('Edit') }}</a>
